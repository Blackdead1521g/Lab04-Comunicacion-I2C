...
void main(void) {
    ...
    while(1){
        ...
        segundos_decimal = bcd_a_decimal(leer_reloj(ds3231_direccion_segundos));
        _delay((unsigned long)((50)*(8000000/4000.0)));
        minutos_decimal = bcd_a_decimal(leer_reloj(ds3231_direccion_minutos));
        _delay((unsigned long)((50)*(8000000/4000.0)));
        horas_decimal = bcd_a_decimal(leer_reloj(ds3231_direccion_horas));
        _delay((unsigned long)((50)*(8000000/4000.0)));
        dia_decimal = bcd_a_decimal(leer_reloj(ds3231_direccion_dias));
        _delay((unsigned long)((50)*(8000000/4000.0)));
        meses_decimal = bcd_a_decimal(leer_reloj(ds3231_direccion_meses));
        _delay((unsigned long)((50)*(8000000/4000.0)));
        biciesto_decimal = bcd_a_decimal(leer_reloj(ds3231_direccion_biciestos));
        _delay((unsigned long)((50)*(8000000/4000.0)));
        ...
        Lcd_Set_Cursor8(1,11);
        Lcd_Write_String8(":");


        if(minutos_decimal <= 9){
...
void escribir_reloj(unsigned char direccion, unsigned int valor){
    I2C_Master_Start();
    I2C_Master_Write(ds3231_escribir);
...
unsigned int leer_reloj(unsigned char direccion){
    ...
    I2C_Master_Write(ds3231_leer);
    bcd = I2C_Master_Read(0);
    I2C_Master_Stop();
